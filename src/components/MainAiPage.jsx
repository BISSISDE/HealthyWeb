...
function Ai() {
  ...
  return (
    <main>
      <div className="bg-black text-white font-sans p-20 -mt-35">
        <div>
          <div>
            <div className="title">
              <h2>
                You can talk with Bot Azamat Skakov and ask questions, take a
                answers, be honest in there!
              </h2>
              <img
                src="https://sun9-77.userapi.com/impg/8BpDj4UNU_oF1-SJiXSfKe-qxeIeiLUe1B9tIQ/ilTKsj7CyXU.jpg?size=2560x2560&quality=95&sign=3f5837f9860747dc62b0513012850b98&type=album"
                alt=""
              />
            </div>
            <div>
